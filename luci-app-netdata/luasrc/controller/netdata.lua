...
function index()
	...
	entry({"admin", "status", "netdata", "setting"}, cbi("netdata/netdata"), _("Base Setting"), 30).leaf=true
	entry({"admin", "status", "netdata", "netdata"}, template("netdata"), _("NetData"), 20).leaf = true
